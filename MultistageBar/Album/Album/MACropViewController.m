...
#import "MACropViewController.h"
#import <UIKit/UIKit.h>

@interface UIImage (CropTools)
- (UIImage *)fixOrientation;
@end

@implementation UIImage (CropTools)
- (UIImage *)fixOrientation {
...
@interface MACropViewController ()<UIScrollViewDelegate>{
    CGFloat _selfHeight;
    CGFloat _selfWidth;
    CGRect _cropFrame;
}
...
@implementation MACropViewController
...
-(void)cancleButtonClick{
    if ([self.delegate respondsToSelector:@selector(ma_cancle)]) {
        [self.delegate ma_cancle];
    }
    [self dismissViewControllerAnimated:YES completion:nil];
}

-(void)sureButtonClick{
    if ([self.delegate respondsToSelector:@selector(ma_cropImage:)]) {
        [self.delegate ma_cropImage:[self getSubImage]];
    }
    [self dismissViewControllerAnimated:YES completion:nil];
}
