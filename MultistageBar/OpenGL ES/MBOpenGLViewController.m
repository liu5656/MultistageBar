...
@interface MBOpenGLViewController () <GLKViewDelegate>
...
@implementation MBOpenGLViewController
...
- (void)commonInit {
    ...
    UIImage *image = [UIImage imageNamed:@"2"]; // 这里如果用 imageNamed 来读取图片，在反复加载纹理的时候，会出现倒置的错误
